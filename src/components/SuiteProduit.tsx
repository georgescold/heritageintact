...
export function SuiteProduit({moment,possede,profil,hub,conclusion=false}:{moment:string;possede:ReadonlySet<ProductSku>;profil?:Reponses|null;hub:string;conclusion?:boolean}) {
 ...
 <p className="mb-4">Ne laissez pas cette question retourner à « plus tard ». Consultez maintenant votre complément : vos achats inclus sont pris en compte et le montant actuel est affiché avant toute confirmation.</p>
