...
export function MesGuidesPdf({jeton,possede}:{jeton:string;possede:Set<ProductSku>}){
 ...
 return <section>
  <h2 className="mb-2 text-[1.5rem]">Tous mes achats à télécharger</h2>
  <p className="mb-5 text-text-soft">Chaque encadré correspond à un contenu que vous avez acheté.</p>
  <ul className="space-y-4">
   {guides.map(g=><li key={g.slug} className="border-2 border-blue bg-grey-bg p-5">
