export function ValeurComplement({av=false,complet=false}:{av?:boolean;complet?:boolean}){
 ...
 <p className="mb-5">{av?"Vous n’achetez pas un autre placement. Vous achetez le fil pour interroger celui que vous avez déjà.":"Vous avez compris les risques généraux. Ce produit distinct transforme maintenant vos réponses en estimation pédagogique, hypothèses visibles et ordre de préparation."}</p>
