...
export function ObjectionsComplement({av=false,dossier=false,testament=false}:{av?:boolean;dossier?:boolean;testament?:boolean}){
 ...
 if(testament){
  items[0]={q:"« Comment ce dossier m’aide-t-il à préparer mon testament ? »",a:"Il clarifie vos volontés, repère les informations manquantes et prépare un brief complet à remettre au notaire. Le professionnel peut ainsi partir de vos priorités réelles pour rédiger la forme adaptée et en confirmer les effets avec vous."};
