...
export function ObjectionsComplement({av=false,dossier=false}:{av?:boolean;dossier?:boolean}){
 const items=[
 {q:"« Je viens déjà d’acheter les 7 erreurs. Pourquoi aller plus loin ? »",a:av?"Le guide de base vous apprend quoi repérer. Ici, vous avez les trames pour demander à l’assureur ce qui est effectivement enregistré, comparer les réponses à votre intention et suivre les points non résolus.":"Le guide vous apprend quoi repérer. Le simulateur + plan adapté utilise vos réponses pour estimer le cas modélisé, révéler ses hypothèses et ordonner les vérifications propres à votre situation."},
