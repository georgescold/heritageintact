    ...
    <section className="relative isolate overflow-hidden">
      ...
      */}
      <div className="wrap-wide relative grid items-center gap-5 py-6 sm:py-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-x-12 lg:gap-y-6 lg:py-12">
        ...
        {/* Le résultat chiffré. Deux chiffres, jamais un pourcentage. */}
        <div className="order-3 max-w-[34rem] rounded border-l-4 border-orange bg-black/40 p-4 lg:col-start-1 lg:row-start-2">
          <p className="mb-2 text-[0.85rem] uppercase tracking-wider text-white/70">
            Sur une maison à 380 000 € et 140 000 € d&apos;épargne
          </p>
          <div className="flex flex-wrap items-end gap-x-4 gap-y-1">
            <span className="figure-lg relative text-white/75">
              82 194 €
              <span
                aria-hidden
                className="absolute inset-x-0 top-1/2 h-[5px] -translate-y-1/2 -rotate-3 bg-red"
              />
            </span>
            <span aria-hidden className="text-[1.6rem] font-bold text-orange">
              →
            </span>
            <span className="figure-lg text-orange">23 794 €</span>
          </div>
          <p className="mt-2 text-[0.88rem] text-white/70">
            Trois décisions. 58 400 € d&apos;écart. Barème officiel, art. 777 du CGI.
          </p>
        </div>

        <div className="order-2 rounded border border-grey-line bg-white p-4 shadow-xl sm:p-5 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:self-center">
  ...
  return (
    <Section tone="blue">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {sources.map((s) => (
          <div key={s.art} className="rounded border border-white/25 bg-white/5 p-4">
...
export function TheNumber() {
  ...
  return (
    <Section tone="grey">
      ...
      <div className="overflow-hidden rounded border border-grey-line bg-white">
  ...
  return (
    <Section tone="grey" wide>
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        <figure>
          <div className="relative aspect-[4/3] overflow-hidden rounded border border-grey-line">
            <Image
      ...
      <p className="wrap mt-6 px-0 text-[1.05rem]">
        La différence entre ces deux tables ne tient ni à l&apos;argent, ni à l&apos;intelligence, ni à
        l&apos;amour qu&apos;on porte à ses enfants. <strong>Elle tient à un après-midi.</strong>
      </p>
    </Section>
  );
}
  ...
  return (
    <Section>
      ...
      <div className="space-y-3">
        {portes.map((p, i) => (
          <div key={p.t} className="flex gap-4 rounded border border-grey-line bg-white p-4">
      ...
      <div className="mt-5 overflow-hidden rounded border-2 border-orange">
...
export function NotThis() {
  const items = [
    {
      ...
      d: "Un testament dit qui reçoit quoi. Il ne réduit la facture d'aucun euro. Beaucoup de familles croient avoir tout réglé parce qu'elles en ont un.",
    },
    {
  ...
  return (
    <Section tone="grey">
      ...
      <div className="space-y-3">
        {items.map((it) => (
          <div key={it.t} className="rounded border border-grey-line bg-white p-4">
...
export function Disqualification() {
  ...
  return (
    <div className="rounded border-2 border-red bg-red-bg p-4 sm:p-5">
