...
export function OffreMethodeHistorique({ action }: { action: ReactNode }) {
  return <section id="la-methode" className="wrap py-10">
    ...
    <ul className="mb-5 space-y-3 text-[1.05rem]">
      <Check><strong>Le guide complet à lire.</strong> Une première étape pour faire le point, puis les sept erreurs expliquées simplement.</Check>
      ...
      <Check><strong>Les fiches utiles du guide.</strong> Vos informations, vos priorités et les premières questions à préparer.</Check>
    </ul>
