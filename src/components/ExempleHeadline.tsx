...
export function ExempleHeadline({compact=false}:{compact?:boolean}){
 return <section id="exemple-chiffre" className="my-7 border-2 border-blue bg-white p-5">
  <p className="text-sm font-bold text-orange-dark">CAS CHIFFRÉ · DEUX ENFANTS · HYPOTHÈSES VISIBLES</p>
  ...
  {!compact&&<div className="mb-4 space-y-4" aria-label="Comparaison des droits dans le cas chiffré">
  ...
  <p className="mt-3 text-sm text-text-soft">Ce cas montre comment les hypothèses changent le calcul. Votre propre résultat sera établi à partir de vos informations, puis confirmé avec le professionnel.</p>
 </section>;
}
