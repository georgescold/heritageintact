  ...
  return (
    <>
      <button
        ...
        className="inline-flex min-h-[60px] w-full cursor-pointer items-center justify-center rounded border-b-4 border-orange-dark bg-orange px-5 text-center text-[1.1rem] font-bold text-white no-underline hover:bg-orange-dark sm:text-[1.2rem]"
      >
        {label}
      </button>
      ...
      {open && (
        ...
        >
          <div
            className="my-auto w-full max-w-md rounded border-2 border-blue bg-white"
