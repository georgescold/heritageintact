    ...
    >
      ...
      <ul className="space-y-1 text-[0.93rem]">
        ...
        <li>
          ...
          (l’abattement) et 6 (le barème) de La Facture Invisible sur la part de cette personne-là,
          avec SON abattement. Si tous vos enfants reçoivent la même part, le chiffre de l’encadré F
          de La Facture Invisible vaut pour chacun d’eux.
        </li>
        {/* Le point 6 de La Facture Invisible EST le barème de la ligne directe. Appliqué à
        ...
        <li>
          ...
          sans lien : le barème de La Facture Invisible ne vaut pas. Calcul à la main avec la
          colonne « Au-delà, il paie » de la feuille des abattements, confirmé par le notaire.
        </li>
      </ul>
      ...
      <Source>
        ...
        Barème en ligne directe, celui de La Facture Invisible : art. 777.
      </Source>
      ...
      <ul className="eviter-coupure space-y-1">
        ...
        <Case>
          La feuille « Les abattements de chacun » et la Facture Invisible sont rangées juste
          derrière celle-ci, et une copie des trois avec le Plan en une page, en tête de classeur.
        </Case>
