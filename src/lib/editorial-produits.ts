...
export const EDITORIAL_PRODUITS = {
 ...
 bump: {
  ...
  essentiel: "Commencez par le cas guidé de Claire et Marc. Reprenez leur logique de classement, puis adaptez chaque ligne à votre situation. Écrivez « à retrouver » plutôt que d’inventer une date : un vide visible avant le rendez-vous est moins dangereux qu’un souvenir présenté comme un fait. Demandez aussi dès la prise de rendez-vous ce qui est inclus, ce qui pourrait être facturé et si un écrit ou un échange supplémentaire nécessite un devis.",
 ...
 upsell1: {
  ...
  limite: "Votre dossier rassemble les éléments nécessaires à l’étude de votre situation. En cas d’urgence juridique, transmettez-le sans attendre au professionnel compétent.",
 ...
 backend4: {
  ...
  limite: "Vous arrivez chez le notaire avec vos volontés hiérarchisées, les personnes et les biens concernés, les contradictions repérées et les pièces utiles. Il peut alors consacrer le rendez-vous à la rédaction, à la validité et aux effets de la solution retenue.",
