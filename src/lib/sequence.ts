...
export const SEQUENCE: Etape[] = [
  ...
  },
  {
    ...
    corps: (p) => [
      ...
      "<strong>Première porte : le compteur des 15 ans.</strong> L'abattement de 100 000 € par parent et par enfant se recharge tous les quinze ans — mais seulement si on l'a utilisé une première fois. Une donation à 62 ans, une autre à 77 : 200 000 € par enfant, sans droits. Rien jusqu'au décès : 100 000 €. Chaque année sans donation est une année perdue, et elle ne revient pas.",
      "<strong>Deuxième porte : 70 ans.</strong> Ce qu'on verse sur une assurance-vie avant cet anniversaire se transmet jusqu'à 152 500 € par bénéficiaire, sans droits. Après : 30 500 € au total, pour tous les bénéficiaires et tous les contrats réunis. La même somme, pas le même traitement.",
      "<strong>Troisième porte : 71 ans.</strong> Donner les murs de sa maison en gardant l'usage à vie, c'est possible. Avant 71 ans, la valeur transmise est calculée sur 60 %. À partir de 71 ans, sur 70 %. Dix points de patrimoine, pour un anniversaire.",
  ...
  },
  {
    ...
    objet: () => `Le prix fondateur, et pourquoi il existe`,
    corps: (p) => [
      `${p},`,
      "Je serai bref.",
    ...
    bouton: { texte: "Accéder au programme", chemin: COMMANDE },
  },
  {
    cle: "j7",
    jour: 8,
