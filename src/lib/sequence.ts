...
export const SEQUENCE: Etape[] = [
  ...
  },
  {
    ...
    corps: (p) => [
      ...
      "Le notaire, lui, intervient quand on l'appelle — c'est-à-dire presque toujours après. Ce n'est pas son métier de vous téléphoner pour vous dire qu'un anniversaire approche.",
  ...
  },
  {
    ...
    corps: (p) => [
      ...
      "Autre doute légitime : <em>« Il faudra de toute façon aller chez le notaire. »</em> Oui. Et c'est précisément le point. Y aller avec un dossier et des décisions plutôt que les mains vides change tout. Il a un devoir de conseil ; simplement, sans votre régime, vos valeurs et vos dates, il ne peut répondre que par des généralités.",
