...
export const PDF_GUIDES: {slug:string;sku:ProductSku;titre:string;description:string;bouton:string}[]=[
 ...
 {slug:"preparation-familiale",sku:"upsell1",titre:"Mon plan adapté à ma situation",description:"Votre guide de préparation : points de vigilance personnalisés, protection future, famille, maison et dossier à remettre au professionnel.",bouton:"Télécharger mon plan adapté"},
