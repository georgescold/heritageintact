...
export const PDF_GUIDES: {slug:string;sku:ProductSku;titre:string;description:string;bouton:string}[]=[
 ...
 {slug:"dossier-notaire",sku:"bump",titre:"Dossier Notaire",description:"Votre dossier pratique pour préparer le rendez-vous : documents à réunir, questions à poser et fiches à compléter.",bouton:"Télécharger mon dossier notaire"},
 {slug:"preparation-familiale",sku:"upsell1",titre:"Simulateur + plan adapté — guide de préparation familiale",description:"Votre guide de préparation : points de vigilance personnalisés, protection future, famille, maison et dossier à remettre au professionnel.",bouton:"Télécharger le guide de préparation"},
