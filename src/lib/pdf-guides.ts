...
export const PDF_GUIDES: GuidePdf[]=[
 ...
 {slug:"bibliotheque-12-situations-familiales",sku:"upsell1",categorie:"achat",titre:"Bibliothèque des 12 situations familiales",description:"Le complément de votre résultat personnalisé : douze fiches de référence et les supports pour préparer les démarches correspondant à votre famille.",bouton:"Télécharger mes 12 fiches pratiques"},
 ...
 {slug:"dossier-testament",sku:"backend4",categorie:"achat",titre:"Dossier Testament",description:"Votre dossier préparatoire pour clarifier vos volontés, détecter les contradictions et préparer leur formalisation avec le notaire.",bouton:"Télécharger mon Dossier Testament"},
