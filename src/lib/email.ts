...
export async function envoyerComplement(lead: Lead, acces: Acces, sku: ProductSku, cle: string, credit: number, montant: number) {
  ...
  const contenu: Contenu = {
    ...
    paragraphes: [
      ...
      sku === "upsell2" ? "Vos contrats d’assurance-vie méritent une lecture organisée : clause en vigueur, informations manquantes et réponse de l’assureur. Le guide vous aide à préparer cette vérification sans modifier un contrat à l’aveugle." : "Le simulateur utilise vos réponses pour faire apparaître une estimation pédagogique, ses hypothèses et un ordre de préparation adapté. Vous savez enfin quels points faire confirmer au lieu de rester face à un cas général.",
