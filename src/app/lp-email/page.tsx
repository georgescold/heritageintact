...
/**
 * PAGE DE CAPTURE SEULE — MISE DE CÔTÉ LE 14/09/2026 (demande de Loys).
 *
 * Elle était l'atterrissage des annonces sur /lp. Les visiteurs cliquaient sur
 * les pubs mais ne laissaient pas leur email ici : /lp affiche désormais la page
 * de vente verrouillée par une fenêtre email (`PopupInscription`). Cette page
 * est conservée telle quelle, à cette adresse, pour pouvoir y revenir.
 *
 * — Historique —
    ...
    <main className="flex-1" data-version-lp="historique-v11" data-role="capture-publicitaire">
      <section className="bg-white pb-9 pt-5 sm:py-14">
        <div className="wrap">
          ...
          <p className="mt-2.5 text-[1.02rem] leading-snug">Découvrez les <strong>7 erreurs à absolument connaitre</strong> afin d’éviter <strong>une trop grosse facture de l’État sur votre succession.</strong></p>
