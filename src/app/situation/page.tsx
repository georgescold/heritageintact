...
export default async function SituationPage({ searchParams }: { searchParams: Promise<{ o?: string }> }) {
  ...
  return <><Header minimal /><main className="wrap max-w-[720px] flex-1 py-7">
    ...
    <p className="mb-5">Vos réponses nous permettent de comprendre ce qui vous inquiète, ce qui vous empêche d’avancer et la suite la plus pertinente à vous présenter. Choisissez simplement la réponse qui vous ressemble le plus aujourd’hui. Le contenu déjà acheté reste identique pour tous.</p>
