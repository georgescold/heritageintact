...
export default function Page() {
  return <><Header minimal /><main className="wrap flex-1 py-8">
    ...
    <h1 className="mb-4 text-[2rem]">La Méthode vous aide à comprendre.<br />Le Dossier vous évite de partir d’une page blanche.</h1>
    ...
    <p className="mb-5 font-bold">La Méthode à 27 € reste complète sans ce Dossier. Vous choisissez l’option à 17 € sur le bon de commande ; elle n’est pas précochée. Le Dossier est aussi inclus dans les packs.</p>
