    ...
    <>
      ...
      <main className="flex-1">
        <div className="wrap py-6 sm:py-10">
          <p className="mb-2 font-bold text-orange-dark">Module 1, en accès libre pendant 24 heures</p>
          ...
          <p className="mb-5 text-text-soft">
            L&apos;abattement de 100 000 € par parent et par enfant se recharge tous les 15 ans, mais
            seulement si on l&apos;a utilisé. Chaque année sans donation est une année perdue. Elle ne
            revient pas.
          </p>
          ...
          <div className="mt-6 space-y-4">
            <p>
              Si ce module vous a parlé, les six autres erreurs sont dans le programme complet, avec le
              Simulateur pour connaître <strong>votre</strong> chiffre ce soir.
            </p>
