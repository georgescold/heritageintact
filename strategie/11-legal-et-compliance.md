...
| « Vous êtes propriétaire » | « Une maison de 480 000 € » (cas) |
...
- ❌ « Économisez 40 % » / « Divisez par 3 » en promesse → ✅ « jusqu'à 60 % » (taux légal réel non-parents) ou un **cas chiffré** présenté comme tel (« sur ce cas, 82 194 → 500 »)
