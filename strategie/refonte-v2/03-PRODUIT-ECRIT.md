...
Action : Remplissez votre fiche de situation. Une information manquante peut être notée « à vérifier ».
...
Action : Complétez la fiche de vos besoins. Notez séparément les donations passées à vérifier.
...
Action : Rédigez une question sur les droits de votre conjoint ou des personnes que vous souhaitez protéger.
...
Action : Retrouvez l’acte de propriété et notez ce que vous voulez préserver concernant le logement.
...
Action : Créez une ligne d’historique pour chaque donation connue et marquez les justificatifs manquants.
...
Action : Écrivez ce que vous voulez expliquer à vos proches et une question sur l’équilibre entre eux.
...
Action : Choisissez trois questions prioritaires et préparez votre demande de rendez-vous.

Supports : plan-en-1-page, regle-mise-a-jour.
