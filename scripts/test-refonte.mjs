...
for(const cle of ["age","vie","residence","detentionResidence","souhaitResidence","immobilier","epargne","titres","autres","dettes","enfants","beauxEnfants","petitsEnfants","fratrie","neveux","sansLien","protectionSignee","personneConfiance","avAvant","avApres","beneficiaires","donationAnnee","donationMontant"])truth(simulateur.includes(`cle: "${cle}"`));
