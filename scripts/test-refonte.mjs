...
const boutique=fs.readFileSync("src/components/espace/Boutique.tsx","utf8");truth(boutique.includes("Obtenir mon plan adapté"));truth(boutique.includes("/plan-complet?o="));truth(boutique.includes("Indispensable pour les détenteurs d’une assurance-vie"));truth(boutique.includes("Découvrir le Dossier Notaire"));
