...
ok(suite("front",front,{av:"O",objectif:"assurance-vie"}).sku==="upsell1");
ok(suite("e2",front,{av:"N"})===null);ok(suite("e2",front,{av:"?"})===null);ok(suite("e2",front,{av:"O"}).sku==="upsell2");
ok(suite("e4",front,{av:"O"}).sku==="upsell1");ok(suite("e4",front,{av:"N"}).sku==="upsell1");
ok(suite("upsell1",prep,{av:"O"}).sku==="upsell2");
ok(suite("upsell2",new Set(["front","upsell2"]),{av:"O"}).sku==="upsell1");
for(const moment of ["e1","e3","e5","e6","lexique","inventaire"])ok(suite(moment,front,{av:"O"})===null);
...
console.log(n+" contrôles éditoriaux V9 réussis : 4 guides, 7 erreurs actives, 25 fiches de compléments, pas de quiz, suites pertinentes et fin de parcours sans revente. Aucun service externe.");
