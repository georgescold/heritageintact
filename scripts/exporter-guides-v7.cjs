...
const {EDITORIAL_PRODUITS,OUVERTURES_CHAPITRES}=mod("src/lib/editorial-produits.ts");
...
fs.writeFileSync("tmp/pdfs/contenu-v7.json",JSON.stringify({editorial:EDITORIAL_PRODUITS,ouvertures:OUVERTURES_CHAPITRES,fichesEditorial:EDITORIAL_FICHES,headline:EXEMPLE_HEADLINE,assurance:EXPLICATIONS_ASSURANCE,lecons:LECONS,guides:GUIDES_UTILISATION,documents:DOCUMENTS.map(d=>({cle:d.cle,titre:d.titre,sku:d.sku,html:renderToStaticMarkup(React.createElement(d.corps,{}))}))},null,2));
