...
for (const file of ["src/app/page.tsx", "src/app/methode/page.tsx"]) {
  ...
  ok(page.includes("<UrgencyBar />")); ok(page.includes(file.includes("/methode/")?"<EcheanceHistorique":"<UrgencyCountdown")); ok(file.includes("/methode/")?page.includes("<EcheanceHistorique"):!page.includes("<ConditionsExoneration")); ok(page.includes(file.includes("/methode/")?"votre mort":"7 erreurs à connaître à temps")); ok(!page.includes("Pas une économie promise."));
