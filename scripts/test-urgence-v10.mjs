...
for (const file of ["src/app/lp/page.tsx", "src/app/methode/page.tsx"]) {
  const page = fs.readFileSync(file, "utf8");
  ok(page.includes("<UrgencyBar />")); ok(file.includes("/methode/")?!page.includes("<EcheanceHistorique"):page.includes("<SortieGuide")); ok(!page.includes("<ConditionsExoneration")); ok(page.includes(file.includes("/methode/")?"votre mort":"7 erreurs à absolument connaitre rapidement")); ok(!page.includes("Pas une économie promise."));
