...
for(const p of ["/admin","/admin/client","/admin/ventes","/espace","/espace/abcdefghijklmnopqrst","/reprendre/xyz","/offre/upsell1","/plan-complet","/kit-assurance-vie","/dossier-complet","/situation","/bienvenue","/merci","/resultat-plan","/simulateur-seul","/desinscription","/derniere-chance","/commande/confirmation"])ok(cheminSansPixel(p),"chemin privé : "+p);
